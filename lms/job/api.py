...
from lms.job.parse import JobParse
from lms.job.rpc import (
    RPC
)
...
class API(APIBase):
    ...
    ENDPOINT = 'http://lmsapi.webaula.com.br/v3/Job.svc?singleWsdl'
    ...
    def get_all(self, data_rq):
        ...
        data = JobParse.get_all(response)
